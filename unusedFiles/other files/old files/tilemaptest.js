(function(){
	...
	var sprite = {
		...
		playerXPos: 400,
		playerYPos: 300,
		movementSpeed: 4.25							  // the speed we are going to move, in pixels per frame
	}
	...
	var level = {
		...
		[22, 8, 8, 8, 8, 6,23, 9, 9, 9, 9, 9, 9, 6, 8, 8, 8, 8, 8, 8, 8, 2, 5, 5, 5, 5, 5, 5, 5, 5, 4, 8,22],
		...
		[22, 8, 8, 8, 6,23, 0,14, 0, 0, 0, 0, 6, 0, 0, 0, 0, 0, 0, 0, 0, 0, 6, 8, 8, 8, 8, 8, 8, 8, 8, 8,22],
	...
	/*
		...
		22 = Abyss = collide
		23 = Stairs down = collide
	*/

	var cantWalkOn = [1,2,3,4,5,6,9,10,11,12,13,15,16,17,18,19,20,21,22,23]
	...
	/*9*/"images/outsideHorizontalWall.png",/*10*/"images/outsideHorizontalWall.png",/*11*/"images/outsideHorizontalWall.png", //these will be different types, stone wood
	...
	/*21*/"images/verticalEndCapDown.png", /*22*/"abyss.png", /*23*/"images/stairDown.png"],
	...
	function renderLevel(){
		...
		var pattern = context.createPattern(spritePic, "repeat");
		
		context.drawImage(spritePic, sprite.playerXPos, sprite.playerYPos);
